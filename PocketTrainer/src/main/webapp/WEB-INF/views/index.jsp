                            ...
                            <h1>${item.head}</h1>
                                ...
                                <%--<div class="info">--%>
                                    <%--<div>--%>
                                        ...
                                        <%--<p>Sentra is free Bootstrap CSS template by--%>
                                            <%--<a rel="nofollow noopener" href="https://templatemo.com">templatemo</a> website.<br>--%>
                                            <%--Please share our site to your friends.</p>--%>
                    ...
                    <div class="owl-carousel owl-theme">
                        ...
                        <div class="item">
                            ...
                            <div class="text-content">
                                ...
                                <span>Maximus</span>
                                <p>#2 You are NOT allowed to re-distribute this on any template website. However, you can put a screenshot of the template and a link back to original template page. Thank you.</p>
                            </div>
                        </div>
                        <div class="item">
                            <div class="image">
